...
logger.info("Silver Kafka pipeline starting", stage="silver_kafka_init")
...
def silver_orders():
    logger.info("Starting orders stream-static join", stage="silver_orders")
    ...
    logger.info("Orders transformation defined", stage="silver_orders", status="SUCCESS")
...
def silver_inventory():
    logger.info("Starting inventory stream ingestion", stage="silver_inventory")
