...
def bronze_orders_kafka():
    logger.info("Starting Kafka orders ingestion", stage="bronze_orders_kafka")
    ...
    logger.info("Kafka orders transformation defined", stage="bronze_orders_kafka", status="SUCCESS")
